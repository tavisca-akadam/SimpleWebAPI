    ...
    stages {
        ...
        stage('SonarQube') {
            steps {
                ...
                sh 'dotnet ${sonarqube-msbuild-netcoreapp}/SonarScanner.MSBuild.dll begin /k:"web_api" /d:sonar.host.url="http://localhost:9000" /d:sonar.login="7525dc0078ec1fc74c53024cb327a998eb70c455"'
                sh 'dotnet build  ${SOLUTION_FILE_PATH}'
                sh 'dotnet ${sonarqube-msbuild-netcoreapp}/SonarScanner.MSBuild.dll end /d:sonar.login="7525dc0078ec1fc74c53024cb327a998eb70c455"'
            }
        }
        stage('Publish') {
            steps {
